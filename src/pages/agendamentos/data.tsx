...
export const data = [
  {
    ...
    description:
      "Olá! Me chamo Camila, sou nutricionista e atuo com demandas de compulsividade, veganismo, vida física ativa, flexibilidade, entre outros. Posso te ajudar nessa caminhada rumo ao autoconhecimento e equilíbrio. Conte comigo, agende sua consulta.",
...

  {
    ...
    description:
      "Olá! Sou um profissional dedicado e apaixonado por ajudar as pessoas a alcançarem uma alimentação saudável. Tenho vasto conhecimento em orientação personalizada, visando o bem-estar e a qualidade de vida dos meus pacientes.",
