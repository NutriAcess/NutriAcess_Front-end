...
export const goalsData = [
  {
    ...
    description:
      "Passe em consultas com nutricionistas de forma prática e acessível.",
  },
  {
    image: { url: IconAccompaniment, alt: "Icone de acompanhamento" },
    title: "Acompanhamento pessoal",
    description:
      "Personalize suas preferências e tenha um acompanhamento de perto!",
  },
  {
    image: { url: IconFuture, alt: "Icone de visão futura" },
    title: "Invista no seu futuro",
    description:
      "Invista em seu futuro com nossos nutricionistas e obtendo resultados a longo prazo.",
  },
  {
    image: { url: IconTime, alt: "Icone de tempo" },
    title: "Gerenciamento de tempo",
    description:
      "Gerencie melhor o seu tempo com o planejador de refeições, de forma rápida e dinâmica.",
  },
  {
    image: { url: IconMark, alt: "Icone de metas" },
    title: "Alcance suas metas",
    description:
      "Alcance suas metas com mais rapidez, e abra espaço para metas novas!",
  },
  {
    image: { url: IconFamily, alt: "Icone de família" },
    title: "Plano familiar",
    description:
      "Passe em consultas, e defina metas personalizados em família.",
  },
];
