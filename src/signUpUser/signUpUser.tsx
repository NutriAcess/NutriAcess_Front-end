...
const Singin: React.FC = () => {
    ...
    return (
        <Container>
            ...
            <Texto1> <Text height={1.7} weight={600} size="28" color="vinho"> Cadastro Especialista </Text></Texto1>
            ...
            <Texto2> <Text height={1.7} weight={600} size="16" color="vinho"> Não tem cadastro? Faça agora mesmo! </Text> </Texto2>
        </Container>
    );
};
