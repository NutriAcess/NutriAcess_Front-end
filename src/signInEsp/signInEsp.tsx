...
const Singin: React.FC = () => {
    ...
    return (
        <Container>
            <Logo/>
            <Texto1><Text height={21} weight={700} size="28" color="vinho"> Login Especialista </Text></Texto1>
            ...
            <Texto2><Text height={21} weight={700} size="16" color="vinho"> Não tem cadastro? Faça agora mesmo!</Text></Texto2>
